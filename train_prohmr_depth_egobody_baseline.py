...
from prohmr.models import ProHMRDepthEgobodyBaseline
...
def train(writer, logger):
    ...
    # Setup model
    model = ProHMRDepthEgobodyBaseline(cfg=model_cfg, device=device, writer=None, logger=None, with_global_3d_loss=args.with_global_3d_loss)
    model.train()
